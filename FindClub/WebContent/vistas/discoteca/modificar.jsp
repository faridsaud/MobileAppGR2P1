	...
	%>
      <form method="post">
        ...
        <div class="form-group">
          ...
          <textarea name="descripcion" class="form-control" rows="5" id="descripcion" placeholder="dirección, tipo de vestimenta, etc", name=descripcion, readonly="true", value=<%=discoModificar.getDescripcion() %> ></textarea>
        </div>
        <div class="form-group">
