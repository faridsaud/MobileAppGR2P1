	...
	<form method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			<label for="nombre">Nombre</label>
				<input name="nombreDiscoteca" id="nombreDiscoteca" class="form-control" placeholder="Nombre"
					value="<%=nombreDiscoteca %>" required="true">
		</div>
       ...
       <label for="pais">Ciudad</label>
		...
		<div class="form-group">
			...
			<textarea name="descripcion" class="form-control" rows="5"
				...
				required="true" value="<%=descripcion%>">
			</textarea>
		</div>
		<div class="form-group">
			<label for="inputFile">Imagen de la discoteca</label> 
			<input name="inputFile" name="pathDiscoteca" id="pathDiscoteca" type="file" id="inputFile" >
